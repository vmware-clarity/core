      ...
      inject: {
        importMap: {
          imports: {
            ...
            '@cds/core/button-action': '/dist/lib/button-action/index.js',
            '@cds/core/button-expand': '/dist/lib/button-expand/index.js',
            '@cds/core/button-handle': '/dist/lib/button-handle/index.js',
            '@cds/core/button-inline': '/dist/lib/button-inline/index.js',
            '@cds/core/button-sort': '/dist/lib/button-sort/index.js',
            '@cds/core/button-split': '/dist/lib/button-split/index.js',
            ...
            '@cds/core/demo': '/dist/lib/demo/index.js',
            ...
            '@cds/core/grid': '/dist/lib/grid/index.js',
            ...
            '@cds/core/signpost': '/dist/lib/signpost/index.js',

...
const icon = {
  outline:
    '<path d="M12 24H14V26H12V24Z" />\n' +
    '<path d="M14 20H12V22H14V20Z" />\n' +
    '<path d="M12 16H14V18H12V16Z" />\n' +
    '<path d="M14 12H12V14H14V12Z" />\n' +
    '<path d="M12 8H14V10H12V8Z" />\n' +
    '<path d="M24 24H16V26H24V24Z" />\n' +
    '<path d="M16 20H24V22H16V20Z" />\n' +
    '<path d="M24 16H16V18H24V16Z" />\n' +
    '<path d="M16 12H24V14H16V12Z" />\n' +
    '<path d="M24 8H16V10H24V8Z" />\n' +
    '<path fill-rule="evenodd" clip-rule="evenodd" d="M8 2H28C29.1046 2 30 2.89543 30 4V32C30 33.1046 29.1046 34 28 34H8C6.89543 34 6 33.1046 6 32V4C6 2.89543 6.89543 2 8 2ZM8 32H28V4H8V32Z" />\n',
  ...
  outlineBadged:
    ...
    '<path d="M24.2547 2H8C6.89543 2 6 2.89543 6 4V32C6 33.1046 6.89543 34 8 34H28C29.1046 34 30 33.1046 30 32V13C29.305 13 28.6337 12.8987 28 12.7101V32H8V4H23.2899C23.5049 3.27757 23.8334 2.60401 24.2547 2Z" />\n' +
    '<path d="M23.2899 8H16V10H24V9.60759C23.6995 9.10887 23.4594 8.56963 23.2899 8Z" />\n' +
    '<path d="M14 8H12V10H14V8Z" />\n' +
    '<path d="M14 12H12V14H14V12Z" />\n' +
    '<path d="M14 16H12V18H14V16Z" />\n' +
    '<path d="M14 20H12V22H14V20Z" />\n' +
    '<path d="M12 24H14V26H12V24Z" />\n' +
    '<path d="M24 24H16V26H24V24Z" />\n' +
    '<path d="M24 20H16V22H24V20Z" />\n' +
    '<path d="M24 16H16V18H24V16Z" />\n' +

...
const icon = {
  ...
  outlineAlerted:
    ...
    '<path d="M23.1594 4H20V8H20.7594L23.1594 4Z" />\n' +
    '<path d="M28 15.0367H32V16H28V15.0367Z" />\n' +
    '<path d="M20 14.1312C20.6254 14.7274 21.4696 15.0541 22.3395 15.0367H26V16H20V14.1312Z" />\n' +
    '<path d="M6 22V30H14V28H16V32H4V20H8V22H6Z" />\n' +
    '<path d="M20 20H26V26H20V20Z" />\n' +
    '<path d="M16 26H10V20H16V26Z" />\n' +
    '<path d="M8 16H4V4H16V8H14V6H6V14H8V16Z" />\n' +
    '<path d="M16 16H10V10H16V16Z" />\n' +
  ...
  outlineBadged:
    ...
    '<path d="M32 12.7101C31.3663 12.8987 30.695 13 30 13V14H28V16H32V12.7101Z" />\n' +
    '<path d="M24.2547 10C24.7288 10.6797 25.3203 11.2712 26 11.7453V16H20V10H24.2547Z" />\n' +
    '<path d="M23 6C23 5.30503 23.1013 4.63371 23.2899 4H20V8H22V6H23Z" />\n' +
    '<path d="M6 22V30H14V28H16V32H4V20H8V22H6Z" />\n' +
    '<path d="M20 26V20H26V26H20Z" />\n' +
    '<path d="M16 26H10V20H16V26Z" />\n' +
    '<path d="M8 16H4V4H16V8H14V6H6V14H8V16Z" />\n' +
    '<path d="M16 16H10V10H16V16Z" />\n' +
    '<path d="M30 22H28V20H32V32H20V28H22V30H30V22Z" />\n',

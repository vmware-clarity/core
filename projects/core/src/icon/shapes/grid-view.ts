...
const icon = {
  ...
  solid:
    '<path d="M20 6C20 4.89543 20.8954 4 22 4H30C31.1046 4 32 4.89543 32 6V14C32 15.1046 31.1046 16 30 16H22C20.8954 16 20 15.1046 20 14V6Z" />\n' +
    '<path d="M6 20C4.89543 20 4 20.8954 4 22V30C4 31.1046 4.89543 32 6 32H14C15.1046 32 16 31.1046 16 30V22C16 20.8954 15.1046 20 14 20H6Z" />\n' +
    '<path d="M22 20C20.8954 20 20 20.8954 20 22V30C20 31.1046 20.8954 32 22 32H30C31.1046 32 32 31.1046 32 30V22C32 20.8954 31.1046 20 30 20H22Z" />\n' +
    '<path d="M6 4C4.89543 4 4 4.89543 4 6V14C4 15.1046 4.89543 16 6 16H14C15.1046 16 16 15.1046 16 14V6C16 4.89543 15.1046 4 14 4H6Z" />\n',
};

...
<Meta title="Internal API/Internal Preview/Row Swappable" />
...
<Story id="internal-stories-grid--row-swappable" />
...
<cds-grid>
  ...
  <cds-grid-placeholder draggable="false"> Move host to staging </cds-grid-placeholder>
  <cds-grid-footer> List One: 1, 2, 3 </cds-grid-footer>
</cds-grid>
...
<cds-grid>
  ...
  <cds-grid-placeholder draggable="false"> Move host to production </cds-grid-placeholder>
  <cds-grid-footer> List Two: 4, 5, 6 </cds-grid-footer>
</cds-grid>
```

...
<Meta title="Internal API/Internal Preview/Column Align" />
...
<Story id="internal-stories-grid--column-align-center" />
...
<Story id="internal-stories-grid--column-align-right" />

...
<Meta title="Internal API/Internal Preview/Borders" />
...
<Story id="internal-stories-grid--border-cell" />
...
<Story id="internal-stories-grid--border-column" />
...
<Story id="internal-stories-grid--border-none" />
...
<Story id="internal-stories-grid--border-stripe" />

## Border Row (default)

<Story id="internal-stories-grid--basic" />
